...
public class pmmlService {
    ...
    public int searchAgg(String keyword) throws JAXBException, IOException, SAXException {
        Resource resource = resourceLoader.getResource("classpath:agg.pmml" );
    ...
    public int searchTox(String keyword) throws JAXBException, IOException, SAXException {
        Resource resource = resourceLoader.getResource("classpath:tox.pmml" );
    ...
    public int searchAtk(String keyword) throws JAXBException, IOException, SAXException {
        Resource resource = resourceLoader.getResource("classpath:atk.pmml" );
